...
from engine.openhands.controller.state.state import State
from engine.openhands.core.message import Message, TextContent
from engine.openhands.events.observation.agent import MicroagentKnowledge
...
class PromptManager:
    ...
    def get_system_message(self, **context) -> str:
        from engine.openhands.agenthub.codeact_agent.tools.prompt import refine_prompt
