...
if TYPE_CHECKING:
    ...
    from engine.openhands.memory.memory import Memory
...
from engine.openhands.mcp.client import MCPClient
from engine.openhands.mcp.error_collector import mcp_error_collector
