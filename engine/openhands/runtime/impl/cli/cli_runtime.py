...
if sys.platform == 'win32':
    try:
        from engine.openhands.runtime.utils.windows_exceptions import DotNetMissingError
        from engine.openhands.runtime.utils.windows_bash import WindowsPowershellSession  # isort: skip
...
class CLIRuntime(Runtime):
    ...
    def _execute_powershell_command(
        ...
        try:
            ...
            from engine.openhands.events.action import CmdRunAction
