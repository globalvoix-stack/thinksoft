...
from engine.openhands.core.config.mcp_config import (
    MCPConfig,
    MCPSSEServerConfig,
...
from engine.openhands.events.action.files import FileEditSource
...
from engine.openhands.events.serialization.action import ACTION_TYPE_TO_CLASS
...
from engine.openhands.runtime.base import Runtime
from engine.openhands.runtime.plugins import PluginRequirement
from engine.openhands.runtime.utils.request import send_request
from engine.openhands.runtime.utils.system_stats import update_last_execution_time
from engine.openhands.utils.http_session import HttpSession
...
class ActionExecutionClient(Runtime):
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from engine.openhands.events.observation import ErrorObservation
        ...
        from engine.openhands.mcp.utils import call_tool_mcp as call_tool_mcp_handler
        from engine.openhands.mcp.utils import create_mcp_clients
